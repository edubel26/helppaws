    ...
    <?php
        class administrador 
        {
            public function elistar($correo_electronico) 
            {
                ...
                echo"            </tbody>";                
                echo"        </table>";
                echo "<form  name='etert' method='POST' action='b-formurario_de_actu_mascota.php' required>";
                echo "<input name='codigo' type='hidden' value='$ccodigo'>";
                echo "<input class='container-bot' type='submit' value='Actualizar'>";
                echo "</form>";

                echo "<form  name='etert' method='POST' action='b-eliminando_mascota.php' required>";
        ...
        echo"<br/>";
        echo"<center>";
        echo"<a href='b-vista_usuario.php'>Ir a menu</a><br/><br/><br/>";
        echo"</center>";
                } 
