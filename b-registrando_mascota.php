...
<?php
         class resistro {
                ...
                public function registro ($nombres_mascota, $raza, $tipo_mascota, $caracteristicas, $sexo, $estado, $correo_electronico, $codigo){
                    ...
                    echo "";
                    echo "<br/>";
                    echo "<center><a href='b-vista_USUARIO.php'>Regresar al MENU</a>";
    ...
    $final=new resistro ();
    $final->registro( $_POST["nombres_mascota"], $_POST["raza"], $_POST["tipo_mascota"], $_POST["caracteristicas"], $_POST["sexo"],   
