...
<body>
    ...
    <div class='contenedor-botones'>
        ...
        <figure>
        <a href="b-registro_mascota.php"><img src='img/menu/b1.png' ></a>
        </figure>
        <figure>
        <a href="b-lista_de_paginas_vacunas.php"><img src='img/menu/b2.png'  ></a>
        </figure>
        <figure>
        <a href="b-lista_de_paginas_esterilizacion.php"><img src='img/menu/b3.png' ></a>     
        </figure>
        <figure>
        <a href="b-reporte_maltrato.php"><img  clas='img'src='img/menu/b4.png'></a>
        </figure>  
        </div>
        </section>       
