...
<form action="c-registrando_mascota.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
...
<input class="botons" type="submit" value="Registrar mascota"> 
        ...
        <center><br/><a href="c-vista_usuario.php">Ir atras</a></center>
    </body>
