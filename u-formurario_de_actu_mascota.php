...
echo"<form action='u-actualizar_mascota.php' method='post' enctype='multipart/form-data' name='form1' id='form1'>";
...
echo"<input class='botons' type='submit' value='Actualizar mascota'>";   
 ?>
        ...
        <center><br/><a href="u-mi_perfil.php">Ir atras</a></center>
    </body>
