...
<body>
    ...
    <img class="logo-menu"
         ...
         class resistrousu {
            ...
            public function registrousu ($nombres_mascota, $raza, $tipo_mascota, $caracteristicas, $sexo, $estado, $correo_electronico, $codigo){
                ...
                echo "";
                echo "<br/>";
                echo "<center><a href='USUARIO.php'>Regresar al MENU</a>";
...
$final=new resistrousu ();
$final->registrousu( $_POST["nombres_mascota"], $_POST["raza"], $_POST["tipo_mascota"], $_POST["caracteristicas"], $_POST["sexo"],   
